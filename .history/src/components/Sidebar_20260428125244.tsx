...
import { Mail, Phone, MapPin, Edit3, ChevronDown, ChevronUp, Award, Globe, Sparkles, Github, Linkedin } from 'lucide-react';
import { PersonalInfo, Skill, Language } from '../types';
import { useLanguage } from '../contexts/LanguageContext';

interface SidebarProps {
  personalInfo: PersonalInfo; skills: Skill[]; languages: Language[];
  onEditPersonalInfo: () => void; onEditSkills: () => void; onEditLanguages: () => void; isAdmin: boolean;
}
...
export default function Sidebar({ personalInfo, skills, languages, onEditPersonalInfo, onEditSkills, onEditLanguages, isAdmin }: SidebarProps) {
